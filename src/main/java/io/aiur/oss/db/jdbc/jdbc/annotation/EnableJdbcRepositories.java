...
import io.aiur.oss.db.jdbc.jdbc.binding.JdbcRepositoryFactory;
import io.aiur.oss.db.jdbc.jdbc.binding.JdbcRepositoryRegistrar;
...
@Documented
@Inherited
@Import(JdbcRepositoryRegistrar.class)
public @interface EnableJdbcRepositories {

    Class<?> repositoryFactoryBeanClass() default JdbcRepositoryFactory.class;
